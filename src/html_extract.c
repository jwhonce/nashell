...
int html_decode_entity(const char *src, char *out, int *advance) {
  ...
  *advance = (int)(semi - src) + 1;
  ...
  if (elen == 2 && p[0] == 'l' && p[1] == 't') {
    out[0] = '<';
    return 1;
  }
  if (elen == 2 && p[0] == 'g' && p[1] == 't') {
    out[0] = '>';
    return 1;
  }
  if (elen == 3 && p[0] == 'a' && p[1] == 'm' && p[2] == 'p') {
    out[0] = '&';
    return 1;
  }
  if (elen == 4 && p[0] == 'q' && p[1] == 'u' && p[2] == 'o' && p[3] == 't') {
    out[0] = '"';
    return 1;
  }
  if (elen == 4 && p[0] == 'a' && p[1] == 'p' && p[2] == 'o' && p[3] == 's') {
    out[0] = '\'';
    return 1;
  }
  if (elen == 4 && p[0] == 'n' && p[1] == 'b' && p[2] == 's' && p[3] == 'p') {
    out[0] = ' ';
    return 1;
  }
